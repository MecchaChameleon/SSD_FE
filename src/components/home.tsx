...
export function AppHeader({role='buyer',showBell=true}:{role?:'buyer'|'seller';showBell?:boolean}){return <View style={s.header}><View style={s.logo}><BrandLogo width="100%" height="100%" viewBox="140 190 1220 320"/></View>{showBell?<NotificationBell role={role}/>:null}</View>}
