...
const s=StyleSheet.create({
  root:{paddingHorizontal:16,paddingTop:16,paddingBottom:82},title:{fontSize:22,fontWeight:'700'},body:{fontSize:13,color:colors.g500,marginTop:6,marginBottom:18},
