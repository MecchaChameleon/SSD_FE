...
export function CompleteScreen({name,userType,onStart}:{name:string;userType:'buyer'|'seller';onStart:()=>void}) { return <View style={s.root}>
  <Character width={124} height={124} style={s.character}/>
