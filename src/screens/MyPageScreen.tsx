...
const profileToBusiness = (profile: SellerProfile): Business => { const numbers=profile.businessNumber.split('-'); return {shop:profile.businessName,representative:profile.representativeName??'',number1:numbers[0]??'',number2:numbers[1]??'',number3:numbers[2]??'',openYear:'',openMonth:'',openDay:'',address:profile.address??'',bank:profile.bankName??'',account:profile.accountNumber??'',latitude:profile.latitude,longitude:profile.longitude}; };
