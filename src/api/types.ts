...
export type Reservation = { id:number; productId:number; productName:string; businessName?:string; buyerId?:number; buyerNickname?:string; quantity:number; unitPrice:number; totalAmount:number; visitStartAt:string|null; visitEndAt?:string|null; status:ReservationStatus; rejectReason?:string|null; requestedAt:string; paymentStatus:'UNPAID'|'PAID' };
