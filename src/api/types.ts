...
export type AiRecommendationReason = { code:string; text:string };
export type AiRecommendedProduct = { product:Product; score:number; reasons:AiRecommendationReason[] };
export type AiRecommendationResponse = { summary:string; weatherSummary:string|null; recommendations:AiRecommendedProduct[] };
